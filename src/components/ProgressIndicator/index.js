...
const ProgressIndicator = ({
  ...
  if (isStartPage) {
    ...
    currentStepTitle = STEP_LABELS.login.props.defaultMessage[0].value;
  } else if (summaryMatch) {
    activeStepTitle = STEP_LABELS.overview;
    currentStepTitle = STEP_LABELS.overview.props.defaultMessage[0].value;
  } else if (confirmationMatch) {
    activeStepTitle = STEP_LABELS.confirmation;
    currentStepTitle = STEP_LABELS.confirmation.props.defaultMessage[0].value;
  } else {
