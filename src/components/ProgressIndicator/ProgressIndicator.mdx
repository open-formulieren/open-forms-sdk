...
<Canvas of={ProgressIndicatorStories.Display} />

### Props

<ArgTypes of={ProgressIndicatorDisplay} />
...
<Story of={ProgressIndicatorStories.ActiveSubmission} />
...
<Story of={ProgressIndicatorStories.InitialFormLoad} />
