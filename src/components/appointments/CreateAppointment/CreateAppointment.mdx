...
The create appointment UI is used when `form.type` is `appointment`. This brings the user in a
(mostly) fixed form step progression to select their products, appointment details and provide
contact details.
