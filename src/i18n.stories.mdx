...
It is recommended to wrap the component in an error boundary **that doesn't require tranlations**. Often
the error message will already be in the appropriate language from the backend.
