...
- The props of the component, introspected via its TS props by Storybook
...
Core feature mocks (like forms, submissions and submission steps) tend to be shared globally and
rather belong in `src/api-mocks`.
