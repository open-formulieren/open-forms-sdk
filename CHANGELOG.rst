...
* Upgraded ``@open-formulieren/formio-renderer`` to 1.8.5 release, fixing:
...
* Applied available security patches in our dependencies.
...
* Upgraded ``@open-formulieren/formio-renderer`` to 1.1.8 release, fixing 3 bugs:
...
* [formio-renderer#357] Upgraded ``@open-formulieren/formio-renderer`` to 1.8.2 release,
...
* [#6458] Fixed a logic evaluation crash when date/datetime values are involved.
...
* Upgraded ``@open-formulieren/formio-renderer`` to 1.8.1 release, which fixes:
  ...
  - [#6434] Fixed interactions with a map component triggering form validation for
    untouched fields.
  - [#6434] Fixed map component stealing focus and skipping over other fields.
  - [#6449] Fixed dates not being properly displayed in validation errors messages.

* [#6359] Fixed missing browser title update in the new renderer when navigating between
  steps.
...
* Upgraded ``@open-formulieren/formio-renderer`` to 1.1.6 bugfix release, which fixes:
...
* [#6245] Fixed address derivation configuration in textfields not being supported in
  the new renderer.
* [#6279] Fixed profile summary data font-size being too big.
* [#6354] Fixed too many network calls being made in address lookups.
